...
Route::group(['middleware' => ['web']], function () {
    ...
    /************************************** Order By Routes for Products By All ***********************************/

    /** Route to sort products by price lowest */
    Route::get('all/price/lowest', [
        'uses' => '\App\Http\Controllers\OrderByController@productsPriceLowestAll',
        'as'   => 'all.lowest',
    ]);

    /**Route to sort products by price highest */
    Route::get('all/price/highest', [
        'uses' => '\App\Http\Controllers\OrderByController@productsPriceHighestAll',
        'as'   => 'all.highest',
    ]);


    /** Route to sort products by alphabetical A-Z */
    Route::get('all/alpha/highest', [
        'uses' => '\App\Http\Controllers\OrderByController@productsAlphaHighestAll',
        'as'   => 'all.alpha.highest',
    ]);

    /**Route to sort products by alphabetical  Z-A */
    Route::get('all/alpha/lowest', [
        'uses' => '\App\Http\Controllers\OrderByController@productsAlphaLowestAll',
        'as'   => 'all.alpha.lowest',
    ]);

    /**Route to sort products by alphabetical  Z-A */
    Route::get('all/newest', [
        'uses' => '\App\Http\Controllers\OrderByController@productsNewestAll',
        'as'   => 'all.newest',
    ]);
