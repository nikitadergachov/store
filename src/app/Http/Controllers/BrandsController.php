...
class BrandsController extends Controller {
    ...
    public function store(BrandsRequest $request) {
        ...
        if (Auth::user()->id == 2) {
            ...
            flash()->success('Выпонлено', 'Бренд добавлен');
        }
    ...
    public function update($id, BrandsRequest $request) {
        ...
        if (Auth::user()->id == 2) {
            ...
            flash()->success('Выполненно', 'Бренд успешно изменён!');
        }
    ...
    public function delete($id) {
        ...
        if ($products > 0) {
            ...
            flash()->customErrorOverlay('Ошибка', 'Под данным брендом есть товары. Удалите все товары под данным прендом');
