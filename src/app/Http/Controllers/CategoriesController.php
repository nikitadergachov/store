...
class CategoriesController extends Controller {
    ...
    public function addPostCategories(CategoryRequest $request) {
        ...
        if (Auth::user()->id == 2) {
            ...
            flash()->success('Выполненно', 'Категория успешно добавлена');
        }
    ...
    public function updateCategories($id, CategoryRequest $request) {
        ...
        if (Auth::user()->id == 2) {
            ...
            // Flash a success message
            flash()->success('Выполненно', 'Категория изменена!');
        }
    ...
    public function deleteCategories($id) {
        ...
        if ($sub_category > 0) {
            ...
            flash()->customErrorOverlay('Ошибка', 'Нельзя удалить категорию пока у неё есть подкатегории!');
    ...
    public function addPostSubCategories($id, CategoryRequest $request) {
        ...
        if (Auth::user()->id == 2) {
            ...
            // Flash a success message
            flash()->success('Выполнено', 'Подкатегория добавлена');
        }
    ...
    public function updateSubCategories($id, CategoryRequest $request) {
        ...
        if (Auth::user()->id == 2) {
            ...
            // Flash a success message
            flash()->success('Выполнено', 'Подкатегория изменена');
        }
    ...
    public function deleteSubCategories($id) {
        ...
        if ($products > 0) {
            // Flash a error overlay message
            flash()->customErrorOverlay('Ошибка', 'Нельзя удалить подкатегорию. В этой подкатегории есть товары');
        } elseif (Auth::user()->id == 2) {
