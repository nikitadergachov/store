    ...
    <div id="wrapper">
        ...
        <div class="container-fluid">
            ...
            <div class="dropdown">
                ...
                <ul class="dropdown-menu">
                    <li><a href="{{ route('category.newest', $category->id) }}">Новизне</a></li>
                    <li><a href="{{ route('category.lowest', $category->id) }}">Возрастанию цены</a></li>
                    <li><a href="{{ route('category.highest', $category->id) }}"> Убыванию цены</a></li>
                    <li><a href="{{ route('category.alpha.lowest', $category->id) }}">По наименованию А-Я</a></li>
                    <li><a href="{{ route('category.alpha.highest', $category->id) }}">По наименованию Я-А</a></li>
                </ul>
            </div>
