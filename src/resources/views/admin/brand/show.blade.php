...
@section('content')
    ...
    <div class="container-fluid" id="admin-brand-container">
        ...
        <a href="{{ url('admin/brands/create') }}" class="btn btn-primary">Добавить новый бренд</a>
            <br><br>
        ...
        <div class="col-md-9" id="admin-brand-container">
            ...
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <th class="text-center blue white-text">Постросмотреть товары бренда</th>
                    <th class="text-center blue white-text">Тест</th>
                    <th class="text-center blue white-text" id="td-display-mobile">Количество товаров бренда</th>
                </tr>
                </thead>
                <tbody>
