...
@section('content')
    ...
    <div class="container" id="admin-brand-container">
        ...
        <a href="{{ url('admin/brands') }}" class="btn btn-danger">Назад</a>
        <br><br>

        <h4 class="text-center">Добавить новый бренд</h4><br><br>
            ...
            <form role="form" method="POST" action="{{ url('admin/brands') }}">
                ...
                <div class="col-sm-8 col-md-8 col-md-offset-2 text-center">
                    <div class="form-group{{ $errors->has('brand_name') ? ' has-error' : '' }}">
                        <input type="text" class="form-control" name="brand_name" value="{{ old('brand_name') }}" placeholder="Добавить новый бренд">
                ...
                <div class="form-group col-sm-8 col-md-8 col-md-offset-2 text-center">
                    <button type="submit" class="btn btn-primary waves-effect waves-light">Создать бренд</button>
                </div>
