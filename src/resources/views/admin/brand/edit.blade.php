...
@section('content')
    ...
    <div class="container" id="admin-brand-container">
        ...
        <h4 class="text-center">Редактировать бренд - {{ $brands->brand_name }}</h4><br><br>
            ...
            {!! Form::model($brands, ['method' => 'PATCH', 'action' => ['BrandsController@update', $brands->id]]) !!}
                ...
                <div class="col-sm-8 col-md-8 col-md-offset-2 text-center">
                    <div class="form-group{{ $errors->has('brand_name') ? ' has-error' : '' }}">
                        <input type="text" class="form-control" name="brand_name" value="{{ Request::old('brand_name') ? : $brands->brand_name }}" placeholder="Редактировать бренд">
