            ...
            <form role="form" method="POST" action="{{ route('admin.category.post') }}">
                ...
                <li class="collection-item">
                    <div class="form-group{{ $errors->has('category') ? ' has-error' : '' }}">
                        <input type="text" class="form-control" name="category" value="{{ old('category') }}" placeholder="Добавить новую категорию">
                ...
                <li class="collection-item blue">
                    <div class="form-group text-center">
                        <button type="submit" class="btn btn-link grey lighten-5">Добавить категорию</button>
                    </div>
                </li>
            </form>
        </ul>
