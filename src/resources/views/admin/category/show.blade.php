...
@section('content')
    ...
    <div class="container-fluid" id="admin-category-container">
        ...
        <a href="{{ url('admin/categories/add') }}" class="btn btn-primary">Добавить новую категорию</a>
            <br><br>
        ...
        <ul class="collection with-header">
            ...
            <li class="collection-item blue">
                ...
                <li class="collection-item primary-color">
                    ...
                    <a href="{{ route('admin.category.addsub', $category->id) }}" id="sub-category">Добавить подкатегорию</a>
                </li>
            </li>
