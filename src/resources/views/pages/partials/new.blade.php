...
<h4 class="text-center animated zoomIn" id="featured-products-heading">Новый товар</h4>
                ...
                @foreach($new as $product)
                    ...
                    <div class="col-sm-6 col-md-3 wow zoomIn" id="featured-container-m">
                        <a href="{{ route('show.product', $product->product_name) }}">
                            ...
                            <div class="col-xs-6">
                                @if ($product->photos->count() === 0)
                                    <img src="/src/public/images/no-image-found.jpg" alt="No Image Found Tag" id="image-m" style="width: 200px; height: 200px;">
                                @else
                                    @if ($product->featuredPhoto)
