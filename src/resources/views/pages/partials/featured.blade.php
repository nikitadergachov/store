...
<h4 class="text-center animated zoomIn" id="featured-products-heading">Рекомендуемые товары</h4>
                ...
                @foreach($products as $product)
                    ...
                    <div class="col-sm-6 col-md-3 animated zoomIn" id="featured-container">
                        ...
                        @if ($product->photos->count() === 0)
                            <img src="/src/public/images/no-image-found.jpg" alt="No Image Found Tag" id="Product-similar-Image" style="width: 200px; height: 200px;">
                        @else
                    ...
                    <div class="col-sm-6 col-md-3 animated zoomIn" id="featured-container-m">
                        <a href="{{ route('show.product', $product->product_name) }}">
                            ...
                            <div class="col-xs-6">
                                @if ($product->photos->count() === 0)
                                    <img src="/src/public/images/no-image-found.jpg" alt="No Image Found Tag" style="width: 200px; height: 200px;" id="image-m">
                                @else
                                    @if ($product->featuredPhoto)
                                        <img src="/{{ $product->featuredPhoto->thumbnail_path }}" alt="Photo ID: {{ $product->featuredPhoto->id }}" class="img-responsive img-thumbnail" id="image-m" />
                                    @elseif(!$product->featuredPhoto)
                                        <img src=/{{ $product->photos->first()->thumbnail_path}}" alt="Photo" class="img-responsive img-thumbnail" id="image-m"  />
                                    @else
                                        N/A
                                    @endif
                                @endif
